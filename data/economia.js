...
(function (global) {
  ...
  var CATEGORIA_INVENTARIO = [
    ...
    { id: 'tuning_vinilo', grupo: 'TUNING', nombre: 'Vinilo de vehículo' },
    { id: 'tuning_chasis', grupo: 'TUNING', nombre: 'Chasis de vehículo' },
    { id: 'tuning_humo_neumaticos', grupo: 'TUNING', nombre: 'Humo de neumáticos' },
    { id: 'tuning_neon', grupo: 'TUNING', nombre: 'Neón de vehículo' },
    { id: 'tuning_exterior', grupo: 'TUNING', nombre: 'Exterior de vehículo' },
    { id: 'tuning_interior', grupo: 'TUNING', nombre: 'Interior de vehículo' },
    { id: 'tuning_bocina', grupo: 'TUNING', nombre: 'Bocina de vehículo' },
    { id: 'tuning_extras', grupo: 'TUNING', nombre: 'Extras de vehículo' },
